...
class ImportPlex(TestCase):
    ...
    @patch("integrations.imports.plex.app.providers.tmdb.tv")
    @patch("integrations.imports.plex.app.providers.tmdb.tv_with_seasons")
    @patch("integrations.imports.plex.app.providers.tmdb.movie")
